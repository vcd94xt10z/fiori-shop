		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Loja Virtual Fiori",
									"targetURL": "#zappfiorishop-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zappfiorishop-display": {
								"semanticObject": "zappfiorishop",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zapp.fiorishop",
									"url": sap.ui.require.toUrl("zapp/fiorishop")
								}
							}
						}
					}
